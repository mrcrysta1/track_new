...
<body translate="no">
            ...
            <div class="front">
                ...
                <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">4242 4242
                            4242 4242</text>
    ...
    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
        ...
        <div class="form-container">
            ...
            <div class="field-container card required">
                <label for="cardnumber">Card Number</label><span id="generatecard">generate random</span>
                <input id="cardnumber" class="card-number" type="text" inputmode="numeric">
                <svg id="ccicon" class="ccicon" width="750" height="471" viewBox="0 0 750 471"
                    version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">

                </svg>
            </div>
            <div class="field-container expiration required">
                <label for="expirationdate">Expiration (mm/yy)</label>
                <input id="expirationdate" class="card-expiry-month-year" type="text" inputmode="numeric">
            </div>
            <div class="field-container cvc required">
                <label for="securitycode">Security Code</label>
                <input id="securitycode" class="card-cvc" type="text" inputmode="numeric">
            </div>
            ...
            <div class="field-container">
                <button type="submit" id="securitycode"
            ...
            transition: transform 80ms ease-in;"
                    onmouseover="this.style.backgroundColor='#FF2D07 '"
                    onmouseout="this.style.backgroundColor='#FF4B2B'">
                    Pay Now
                </button>
            </div>
        </div>
        ...
        window.onload = function() {
            ...
            cardnumber_mask.on('accept', function() {
                if (cardnumber_mask.value.length == 0) {
                    document.getElementById('svgnumber').innerHTML = '4242 4242 4242 4242';
                } else {
            ...
            expirationdate_mask.on('accept', function() {
                if (expirationdate_mask.value.length == 0) {
                    document.getElementById('svgexpire').innerHTML = '12/28';
                } else {
        ...
        $(function() {
            ...
            $('form.require-validation').bind('submit', function(e) {
                ...
                if (!$form.data('cc-on-file')) {
                    ...
                    var month_year = $('.card-expiry-month-year').val();
                    const myArray = month_year.split("/");
                    var month = myArray[0];
                    var year = '20'+ myArray[1];
                    Stripe.createToken({
